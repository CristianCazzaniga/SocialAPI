...
{
    build.WithOrigins("https://localhost:5173", "http://localhost:5173", "http://127.0.0.1:5173").AllowAnyMethod().AllowAnyHeader();
}));
...
{
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "Social_ApiV1");
